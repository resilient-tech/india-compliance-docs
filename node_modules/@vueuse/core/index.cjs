...
function useActiveElement(options = {}) {
  ...
  const activeElement = shared.computedWithControl(() => null, () => window == null ? void 0 : window.document.activeElement);
  if (window) {
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = vueDemi.computed(() => foramtTimeAgo(new Date(shared.resolveUnref(time)), options, vueDemi.unref(now.value)));
  if (exposeControls) {
...
exports.foramtTimeAgo = foramtTimeAgo;
