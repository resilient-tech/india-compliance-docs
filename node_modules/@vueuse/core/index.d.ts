...
declare type KeyFilter = true | string | string[] | KeyPredicate;
 ...
 * @param options
 */
declare function useActiveElement<T extends HTMLElement>(options?: ConfigurableWindow): _vueuse_shared.ComputedRefWithControl<T | null | undefined>;
 ...
 * @param options
 */
declare function useEventListener<E extends keyof DocumentEventMap>(target: Document, event: Arrayable<E>, listener: Arrayable<(this: Document, ev: DocumentEventMap[E]) => any>, options?: boolean | AddEventListenerOptions): Fn;
/**
 * Register using addEventListener on mounted, and removeEventListener automatically on unmounted.
 *
...
declare type ContrastType = 'more' | 'less' | 'custom' | 'no-preference';
/**
...
declare type ReducedMotionType = 'reduce' | 'no-preference';
/**
...
declare type UseSortedCompareFn<T = any> = (a: T, b: T) => number;
declare type UseSortedFn<T = any> = (arr: T[], compareFn: UseSortedCompareFn<T>) => T[];
...
declare type UseTimeAgoUnitNamesDefault = 'second' | 'minute' | 'hour' | 'day' | 'week' | 'month' | 'year';
...
declare type UseTimeAgoMessages<UnitNames extends string = UseTimeAgoUnitNamesDefault> = UseTimeAgoMessagesBuiltIn & Record<UnitNames, string | UseTimeAgoFormatter<number>>;
...
declare function foramtTimeAgo<UnitNames extends string = UseTimeAgoUnitNamesDefault>(from: Date, options?: FormatTimeAgoOptions<UnitNames>, now?: Date | number): string;
...
declare type UseTitleOptionsBase = {
    /**
...
declare type UseTitleOptions = ConfigurableDocument & UseTitleOptionsBase;
...
declare type UseVirtualListOptions = UseHorizontalVirtualListOptions | UseVerticalVirtualListOptions;
