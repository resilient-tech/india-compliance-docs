...
<template>
  <article
    class="p-6 rounded-lg border border-[color:var(--vp-c-brand)] shadow-md dark:border-[color:var(--vp-c-brand)]"
  >
    ...
    <h2 class="mb-2 text-2xl font-bold tracking-tight text-[color:var(--vp-c-brand)] dark:text-[color:var(--vp-c-brand)]">
      <a
